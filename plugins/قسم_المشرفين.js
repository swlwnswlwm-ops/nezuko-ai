// م1.js - قسم المشرفين (ADMIN)
// تم التعديل لاستخدام روابط سريعة وإرسال صورة/فيديو مثل الكود الثاني
...
let handler = async (m, { conn, usedPrefix }) => {
  // 1. مصفوفة الروابط السريعة (مثل الكود الثاني)
  const assets = [
